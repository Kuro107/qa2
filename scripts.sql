...
CREATE TABLE airport (
                                   ...
                                   country_code VARCHAR NOT NULL REFERENCES country(country_code),
...
CREATE TABLE clients (
                                   ...
                                   country varchar NOT NULL REFERENCES country(country_code)
...
CREATE TABLE flight (
                                  ...
                                  departure_from VARCHAR NOT NULL REFERENCES airport(airport_code),
                                  where_arriving VARCHAR NOT NULL REFERENCES airport(airport_code),
...
CREATE TABLE tickets (
                                   ...
                                   flight_code VARCHAR NOT NULL REFERENCES flight(flight_num),
